...
function testSpeech() {
  ...
  var grammar =
    "#JSGF V1.0; grammar phrase; public <phrase> = " + phrases + ";";
  ...
  recognition.onresult = function (event) {
    ...
    if (speechResult == "instructions" || speechResult == "instruction") {
      ...
      testThis.onend = function (event) {
        console.log(
          "No such operation over. speak time:" +
            event.elapsedTime +
            " milliseconds."
        );
        instruct();
...
function startTimer() {
  ...
  utterThis.onend = function (event) {
    console.log(
      "Instructions over. speak time:" + event.elapsedTime + " milliseconds."
    );
    speech("start");
  };
}
