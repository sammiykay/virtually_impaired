                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="oq-viewTests" id="test">
                                            <div class="oq-instruct">
                                                ...
                                                <p id="instructions">Instructions are <br>1. The questions will be spoken out, you need to select the correct option by saying its option number. example if the correct answer is option 2 then you need to say option 2 then that perticular option will be selected. <br>2. To repeate a question you need to say the word repeat question.<br>3. You can even navigate between questions by saying the question numbers example, question 2 then question 2 will be spoken.<br>4. You can submit any time while taking the quiz to submit you need to say submit, your test will be submitted and resutls are shown.<br><br>Say start to start your exam with timer<br></p><br>
